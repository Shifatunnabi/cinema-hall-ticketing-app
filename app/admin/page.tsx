      ...
      <div className="p-4 md:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#3F4F44]">
            Welcome back, Admin. Here's what's happening at your cinema.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
          <Card className="bg-white shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-[#3F4F44]">
                Today's Revenue
              </CardTitle>
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              <div className="text-xl md:text-2xl font-bold text-[#2C3930]">
                {mockAnalytics.today.totalTickets}
              </div>
        ...
        <Card className="bg-white shadow-lg">
          <CardHeader>
            <CardTitle className="text-lg md:text-xl font-bold text-[#2C3930]">
              Revenue Analytics
            </CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div className="bg-[#A2785C]/10 p-4 rounded-lg">
                      <h3 className="font-semibold text-[#2C3930] mb-2">
                        Total Revenue
                      </h3>
                    ...
                    <div className="bg-[#3F4F44]/10 p-4 rounded-lg">
                      ...
                      <p className="text-xl md:text-2xl font-bold text-[#3F4F44]">
                        {mockAnalytics.today.totalTickets}
                      </p>
                    </div>
                  </div>

                  <h4 className="font-semibold text-[#2C3930] mb-4">
                    Show-wise Breakdown
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {mockAnalytics.today.shows.map((show, index) => (
                      <div
                        key={index}
                        className="border border-[#3F4F44]/20 p-4 rounded-lg"
                      >
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="bg-[#3F4F44]/10 p-4 rounded-lg">
                      ...
                      <p className="text-xl md:text-2xl font-bold text-[#3F4F44]">
                        {mockAnalytics.month.totalTickets}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="bg-[#3F4F44]/10 p-4 rounded-lg">
                      ...
                      <p className="text-xl md:text-2xl font-bold text-[#3F4F44]">
                        {mockAnalytics.year.totalTickets}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mb-6 text-sm text-[#3F4F44]">
          Manage admins and moderators in the{" "}
